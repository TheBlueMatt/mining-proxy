...
println!("Encoded weak block to len {} with {} bytes in {} new txn for {} txn", res.len() - start_len, new_txn_len, new_txns, txn_count);
println!("Common overhead: {}", 4*5+32+1+self.user_tag.len());
	}
}
